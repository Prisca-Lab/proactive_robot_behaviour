...
function dn_action(result){
    ...
    if(result["Help"] != "None"){
        ...
        file["partita"]["livello"][level]["sequenza"][indexMatchCard]["mossa"][mossa-1]["random_come"] = result_decision["How"]
        ...
        timeout_decision = setTimeout(function(){
            activeDecision(come_richiedo[result_decision["How"]], index)
        }, time);
    }
}
